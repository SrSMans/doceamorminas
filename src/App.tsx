...
export default function App() {
  ...
  useEffect(() => {
    ...
    window.addEventListener('setPage', handlePageChange as EventListener);
    return () => {
      window.removeEventListener('setPage', handlePageChange as EventListener);
    };
  }, []);
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1">
        ...
        {currentPage === "CARDAPIO" && <Menu />}
        {currentPage === "SOBRE NÓS" && <About />}
