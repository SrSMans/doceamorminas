          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <div className="space-y-6">
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                 <p className="text-sm text-gray-500">Para pagamentos via PIX, utilize a chave: <strong className="text-gray-700">32988759023</strong> (Celular)</p>
                 <p className="text-sm text-gray-500 mt-1">Titular: Angela Nascimento Laureth</p>
              </div>
            </div>
          </div>
